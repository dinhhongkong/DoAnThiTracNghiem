...
enum Display{DISPLAY_LOGIN, DISPLAY_HOCSINH, DISPLAY_GIAOVIEN,DISPLAY_DSMON,DISPLAY_DSLOP,DISPLAY_DSSV,DISPLAY_DIEMMON, LUACHON_LOP, DISPLAY_CAUHOIMON, CHUCNANG_CAUHOI, DISPLAY_CAIDATTHI, DISPLAY_LICHTHI};
