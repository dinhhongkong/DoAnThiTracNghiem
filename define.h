...
enum ScanType{ ONLY_NUMBER, ONLY_TEXT, SPACE_TEXT, TEXT_NUMBER,TEXT_NUMBER_NO_SPACE, SCAN_MALOP, DATE_TIME, ISBN, MASACH};
enum Display{DISPLAY_LOGIN, DISPLAY_HOCSINH, DISPLAY_GIAOVIEN};
