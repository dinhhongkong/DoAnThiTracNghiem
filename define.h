...
enum ScanType{ ONLY_NUMBER, ONLY_TEXT, SPACE_TEXT, TEXT_NUMBER,TEXT_NUMBER_NO_SPACE, SCAN_MALOP, SCAN_PASS, SCAN_ALL};
enum Display{DISPLAY_LOGIN, DISPLAY_HOCSINH,DISPLAY_DOIMK,LUACHON_THI_HS ,DISPLAY_HSTHI, DISPLAY_DIEMSV , DISPLAY_GIAOVIEN,DISPLAY_DSMON,DISPLAY_DSLOP,DISPLAY_DSSV,DISPLAY_DIEMMON, DISPLAY_DSDIEMGV, LUACHON_LOP, LUACHON_MON, CHUCNANG_CAUHOI, DISPLAY_THITHU, VAO_THITHU, XEMBAI_THUTHU};
