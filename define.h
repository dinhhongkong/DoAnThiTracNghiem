...
enum Display{DISPLAY_LOGIN, DISPLAY_HOCSINH,DISPLAY_DOIMK, DISPLAY_GIAOVIEN,DISPLAY_DSMON,DISPLAY_DSLOP,DISPLAY_DSSV,DISPLAY_DIEMMON, DISPLAY_DSDIEMGV, LUACHON_LOP, LUACHON_MON, CHUCNANG_CAUHOI, DISPLAY_THITHU, VAO_THITHU};
